...
class Condition_Events():
    ...
    @staticmethod
    def handle_illnesses(cat, season=None, skiptype='moon'):
    ...
    @staticmethod
    def handle_injuries(cat, other_cat=None, alive_kits=None, war=None, enemy_clan=None, season=None, skiptype='moon'):
